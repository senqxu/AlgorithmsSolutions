...
public class NumberOf1 {
     ...
     */
    public static int replace1(int n){
        int count = 0;
    ...
    private static int  replace2(int n) {
        int t = 0;                //将n转为二进制的字符，利用循环遍历思想，遍历是否为1
    ...
    public static void main(String[] args) {
        System.out.println(NumberOf1.replace(13));
        System.out.println(NumberOf1.replace1(15));
        System.out.println(NumberOf1.replace2(22));
    }
}
